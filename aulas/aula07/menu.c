...
//color doce c rabaDabaDoba
// melhorar texto: ascii art - patorjk.com
#define BLK "\e[0;30m"
#define RED "\e[0;31m"
#define GRN "\e[0;32m"
#define YEL "\e[0;33m"
    ...
    while(opcao != 4){
        ...
        switch(opcao){
            ...
            case 2: {
                ...
                printf("2 - Jogador B - 85000 pontos\n");
                printf("3 - Jogador C - 8000 pontos\n");
                printf("4 - Jogador D - 5000 pontos\n");
                printf("5 - Jogador E - 3000 pontos\n");
                printf("6 - Jogador F - 1000 pontos\n");
